...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"adminPageCC.js":[function(require,module,exports) {
"use strict";
...
module.exports.adminPageCate = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://localhost:3000/api/v1/admin/adminCate', {
            category: category
          });
        case 3:
        ...
        case 7:
          ...
          console.log(_context.t0 + 'axios mistake');
        case 10:
        case "end":
...
module.exports.adminPageCoun = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          console.log(country);
          _context2.next = 4;
          return _axios.default.post('http://localhost:3000/api/v1/admin/adminCoun', {
            country: country
          });
        case 4:
...
},{"axios":"../../node_modules/axios/index.js"}],"userUpdate.js":[function(require,module,exports) {
"use strict";
...
module.exports.updateUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userId, countrySelect, categorySelect) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch("http://localhost:3000/api/v1/admin/updateUserModel/".concat(userId), {
        ...
        case 3:
          ...
          if (response.data.status === 'success') {
            ...
            window.location.href = 'http://localhost:3000/api/v1/views/meetRandomPeople';
          }
          _context.next = 10;
          break;
        case 7:
...
var _axios = _interopRequireDefault(require("axios"));
var _adminPageCC = require("./adminPageCC");
var _userUpdate = require("./userUpdate");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import SimplePeer from 'simple-peer'
// import ws from 'ws'
// import Peer from 'peer'
var catSub = document.querySelector('.catSub');
var couSub = document.querySelector('.couSub');
var userSelectionOneTime = document.querySelector('.userSelectionOneTime');
if (catSub) catSub.addEventListener('submit', function (e) {
  e.preventDefault();
  var category = document.getElementById('cate').value;
  (0, _adminPageCC.adminPageCate)(category);
});
if (couSub) couSub.addEventListener('submit', function (e) {
  e.preventDefault();
  var country = document.getElementById('coun').value;
  (0, _adminPageCC.adminPageCoun)(country);
});
if (userSelectionOneTime) userSelectionOneTime.addEventListener('click', function (e) {
  e.preventDefault();
  ...
  (0, _userUpdate.updateUser)(userId, categorySelect, countrySelect);
});
},{"axios":"../../node_modules/axios/index.js","./adminPageCC":"adminPageCC.js","./userUpdate":"userUpdate.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
